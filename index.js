...
const DB =
  "mongodb+srv://vick-254:ErumamaadU%40143@typeracer-cluster.rnjxp7r.mongodb.net/?retryWrites=true&w=majority&appName=TypeRacer-Cluster";
        ...
        (async () => {
          try {
            ...
            game.players.forEach((player, index) => {
              if (player.WPM === -1) {
                game.players[index].player.WPM = calculateWPM(
                  endTime,
                  startTime,
                  player
                );
